...
icon: material/home
---
<div class="hero-section"><div class="hero-title">Laboratório CEEPIRG</div><p style="font-size:1.4rem; opacity:0.9">Single-Cell RNA-seq | Neuroimunologia | Bioinformática</p><br><a href="projetos/" class="md-button md-button--primary">Ver Projetos</a></div>
